let welcomeText =
	'Hello This is a welcome page\nTemplate created by GSV\nYou can continue by signing in with username root.';
...
let listOfFiles = {
	...
	'About_Me.txt': () => {
		historyCommands += "Hi I'm G Sharan Raghav<br><br>";
	},
	'Contact_Me.txt': () => {
		historyCommands +=
			'You can get in touch with me in any social media websites, By Searching G Sharan Raghav in google<br><br>';
	},
	'Github.txt': () => {
		historyCommands +=
			"<a href = 'https://github.com/Deathshadow333' target='_blank'>https://github.com/Deathshadow333</a><br><br>";
	},
	'Linkedin.txt': () => {
		historyCommands +=
			"<a href = 'https://www.linkedin.com/in/gsharanraghav8/' target='_blank'>https://www.linkedin.com/in/gsharanraghav8/</a><br><br>";
	},
	'Credits.txt': () => {
		historyCommands +=
			"Created by: GSV<br><a href = 'https://github.com/Deathshadow333' target='_blank'>https://github.com/Deathshadow333</a><br>";
	},
};
...
let clText = '<span id = "path">root@user:~$</span>'; //this should be changed
...
const credits = () => {
	Terminalon();
	setTimeout(() => comm('cat Made By.txt', true), 100);
	textInput.focus();
};
const nonSudo = (w) => {
